...
const dayjs = require ('dayjs');
    ...
    async function log (client) {
      ...
      const errChannel = client.channels.cache.get('1044258472121860126'); const donLogChannel = client.channels.cache.get('1058381353336438865');
  ...
  if (nb != 0) { var nb = nb -2 +1
     ...
     donLogChannel.send({embeds: [embed]})}; 
        ...
        await new Promise(resolve => setTimeout(resolve, 60000))}; log()}
