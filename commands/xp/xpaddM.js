...
module.exports = {
    ...
    description: 'Actualise les xp des membres',
       async run (client, message, args) {
        ...
        console.log ('Commande xpaddm faite');
      ...
      for (var i = 0; i < Messageclan.body.length;i++){ 
        ...
        try {
        var xpData = await xpAdd.findOne({ Id: data.playerId }); console.log(xpData.Pseudo, xpData.xp)}catch(err) {}
    ...
    async runSlash(client, interaction) { 
      ...
      console.log ('Commande xpaddm fait'); 
      var objErr= JSON.stringify(Messageclan);
