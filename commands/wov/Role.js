...
module.exports = {
  ...
  description: "La commande role envoie la liste du mode de jeu choisis",
    async run (client, message, args) {
        ...
        var Rol1Q = RoleQuick[1-1]; if (Rol1Q[0].probability ==0.5) {
        ...
        var Rol2Q = RoleQuick[2-1]; if (Rol2Q[0].probability ==0.5) {
        ...
        var Rol3Q = RoleQuick[3-1]; if (Rol3Q[0].probability ==0.5) {
        ...
        var Rol4Q = RoleQuick[4-1]; if (Rol4Q[0].probability ==0.5) {
        ...
        var Rol5Q = RoleQuick[5-1]; if (Rol5Q[0].probability ==0.5) {
        ...
        var Rol6Q = RoleQuick[6-1]; if (Rol6Q[0].probability ==0.5) {
        ...
        var Rol7Q = RoleQuick[7-1]; if (Rol7Q[0].probability ==0.5) {
          console.log(`${Rol16Q[0].role} avec ${Rol16Q[0].probability} de chance ou ${Rol16Q[1].role} avec ${Rol16Q[1].probability} de chance`)} else {console.log(Rol7Q[0].role)}
        var Rol8Q = RoleQuick[8-1]; if (Rol8Q[0].probability ==0.5) {
        ...
        var Rol9Q = RoleQuick[9-1]; if (Rol9Q[0].probability ==0.5) {
        ...
        var Rol10Q = RoleQuick[10-1]; if (Rol10Q[0].probability ==0.5) {
        ...
        var Rol11Q = RoleQuick[11-1]; if (Rol11Q[0].probability ==0.5) {
        ...
        var Rol12Q = RoleQuick[12-1]; if (Rol12Q[0].probability ==0.5) {
        ...
        var Rol13Q = RoleQuick[13-1]; if (Rol13Q[0].probability ==0.5) {
        ...
        var Rol14Q = RoleQuick[14-1]; if (Rol14Q[0].probability ==0.5) {
        ...
        var Rol15Q = RoleQuick[15-1]; if (Rol15Q[0].probability ==0.5) {
        ...
        var Rol16Q = RoleQuick[16-1]; if (Rol16Q[0].probability ==0.5) {
